...
# Note that we don't check the immutable contents of the nested objects inside each list value in 
# the dictionaries. Since they are all immutable, they weren't duplicated. Try it by adding these 
# additional tests.
